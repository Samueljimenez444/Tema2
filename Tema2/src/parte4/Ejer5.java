...
public class Ejer5 {
	...
	public static void main(String[] args) {
		// Creamos la variable entera edad y la inicializamos en 1 para que pueda
		// cumplir la condicion de nuestro bloque while. Esta variable almacenara las
		// edades que introduzca el usuario
		int edad = 1;
		// Creamos la variable entera edadMayor que servira para contabilizar cuantos
		// alumnos son mayores de edad
		int edadMayor = 0;
		// Creamos la variable entera suma que servira para calcular posteriormente la
		// media de edades
		int suma = 0;
		// Creamos la variable tipo double media que servira para calcular la media de
		// edades introducidas
		double media = 0.0;
		// Creamos la variable tipo double media que servira para calcular la media de
		// edades introducidas siendo el contador el numero de edades introducidas por
		// el usuario
		double contador = -0.0;
		...
		// Si edad>=18 aumentamos en 1 la cantidad de la variable edadMayor es decir si
		// algun alumno es mayor de edad o no
		if (edad >= 18) {
			edadMayor++;
		}
		while (edad >= 0) {// Mientras edad>=0 (Cuando se introduzca 0 el programa finalizara
			...
			if (edad >= 18) {// Si edad>=18 aumentamos en 1 la cantidad de la variable edadMayor es decir si
								// algun alumno es mayor de edad o no
				edadMayor++;
			}
		}
